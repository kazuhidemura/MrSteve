...
from mrsteve.lib.VPT.lib.action_head import make_action_head
from mrsteve.lib.VPT.lib.impala_cnn import ImpalaCNN
from mrsteve.lib.VPT.lib.scaled_mse_head import ScaledMSEHead
from mrsteve.lib.VPT.lib.tree_util import tree_map
from mrsteve.lib.VPT.lib.util import FanInInitReLULayer, ResidualRecurrentBlocks
from mrsteve.lib.VPT.lib.misc import transpose
...
class MinecraftAgentPolicy(nn.Module):
    ...
    def act(self, obs, first, state_in, stochastic: bool = True,
        ...
        softmax_buttons = th.nn.functional.softmax(buttons, dim=-1)
